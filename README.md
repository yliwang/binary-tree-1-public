This assignment needs only implement code in leafnode.c, and within the fucntion get_num_leaf, the function, as the name indicates, count the number of leaf nodes in a binary tree, and return it.
